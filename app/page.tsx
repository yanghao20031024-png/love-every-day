...
export default function Home() {
  const { data, loading } = useLoveData();
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { href: "/wishlist", emoji: "🌟", label: "愿望清单", desc: "共同的梦想" },
          { href: "/coupons", emoji: "🎫", label: "爱情券", desc: "甜蜜的约定" },
          { href: "/daily", emoji: "💬", label: "每日情话", desc: "今天想对你说" },
          { href: "/countdown", emoji: "🎂", label: "纪念日", desc: "重要的日子" },
        ].map((item) => (
